...
#adds a constant column to input data set. --> d(1) for completing eqn-->ax+by+cz+d(1)
...
features_opt = features[:, [0, 1, 2, 3, 4, 5]]  #create duplicate of features for further progress
